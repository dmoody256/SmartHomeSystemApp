...
public class LoginActivity extends Activity{
     ...
     */
    Button LoginBackButton;   // Button to go to the previous screen
    Button LoginHomeButton;   // Button to go to the home screen
    Button ForgotLoginButton; // Button to send user there password
    Button LoginButton;       // Button to attempt to log in to the system
    EditText UsernameEdit;    // Enter the username to log on
    EditText PasswordEdit;    // Enter the password to log on
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState); // create the activity instance
        setContentView(R.layout.login);     // connect the activity to its GUI layout
        ...
        if(Values.DBconnection == false)
        {
            Toast.makeText(getBaseContext(),
                    "Database not Avialable",  // notify the suer the connection failed
         ...
         */
        LoginBackButton = (Button)findViewById(R.id.logloginback); // Connect the activity 
        LoginHomeButton = (Button)findViewById(R.id.logloginhome); // objects to there GUI
        LoginButton = (Button)findViewById(R.id.logsubmit);        // objects
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
        ...
        LoginBackButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                startActivity(SmartHomeSystemIntent); // Send the user back to the previous screen
                finish();
            }
        ...
        LoginHomeButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent SmartHomeSystemIntent = new Intent(getApplicationContext(), 
                        SmartHomeSystemActivity.class);
                startActivity(SmartHomeSystemIntent); // Send the user back to the home screen
                finish();
            }
        ...
        protected String doInBackground(String... URItoSend) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                try {
                    ...
                    mySQLiteAdapter.close(); // close the database after data has been entered
            ...
            Values.DBconnection = false;  // this code make be obsolete needs fix
